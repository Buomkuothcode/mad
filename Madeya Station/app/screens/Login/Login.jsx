...
const Login = () => {
  ...
  const handleHelp = async () => {
    // Use a relevant help link for "Madeya" if available, otherwise keep the Telegram link or generic support URL
  ...
  try {
    ...
    if (userRole !== 'station') {
      ...
      if (userRole === 'truck') {
        ...
        errorMessage = 'This app is for car drivers only. Please use the fuel Car app.';
      } else if (!userRole) {
